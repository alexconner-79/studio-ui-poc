...
function SignupForm() {
      ...
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-zinc-50 to-zinc-100 dark:from-zinc-950 dark:to-zinc-900 px-4">
        <div className="w-full max-w-md space-y-6">
          <div className="text-center space-y-2">
            <div className="inline-flex items-center justify-center w-12 h-12 rounded-xl bg-emerald-600 text-white font-bold text-lg">
              ✓
            </div>
            ...
            <p className="text-sm text-zinc-500 dark:text-zinc-400">
              We sent a confirmation link to <strong className="text-zinc-700 dark:text-zinc-300">{email}</strong>.
          ...
          <Card className="p-6 shadow-lg border-zinc-200 dark:border-zinc-800">
            <p className="text-center text-sm text-zinc-500 dark:text-zinc-400">
              Already confirmed?{" "}
              <Link
                href={`/login${from !== "/studio" ? `?from=${encodeURIComponent(from)}` : ""}`}
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-zinc-50 to-zinc-100 dark:from-zinc-950 dark:to-zinc-900 px-4">
      <div className="w-full max-w-md space-y-6">
        <div className="text-center space-y-2">
          <div className="inline-flex items-center justify-center w-12 h-12 rounded-xl bg-zinc-900 dark:bg-zinc-100 text-white dark:text-zinc-900 font-bold text-lg">
            S
          </div>
          <h1 className="text-2xl font-bold tracking-tight text-zinc-900 dark:text-zinc-100">
            Create your account
          ...
          <p className="text-sm text-zinc-500 dark:text-zinc-400">
            Get started with Studio UI
          </p>
        </div>

        <Card className="p-6 space-y-6 shadow-lg border-zinc-200 dark:border-zinc-800">
          ...
          <form onSubmit={handleSignup} className="space-y-4">
            ...
            <div className="space-y-2">
              <label htmlFor="full-name" className="text-sm font-medium text-zinc-700 dark:text-zinc-300">
                Full name
              </label>
              <Input
                id="full-name"
